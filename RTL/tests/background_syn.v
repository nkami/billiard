...
//lpm_constant ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="NONE" LPM_CVALUE=08 LPM_WIDTH=8 result
...
module background (
	...
	background_lpm_constant	background_lpm_constant_component (
				.result (sub_wire0));
